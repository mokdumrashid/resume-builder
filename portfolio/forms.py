...
class PortfolioForm(forms.ModelForm):
    class Meta:
        ...
        "phone", "profile_image", "links", "Basic_information", "education", "certificate_and_work_experience", "skills", "reference" )
        widgets = {
            ...
            'reference': SummernoteWidget(attrs={'summernote':{'width':'100%'}}),
